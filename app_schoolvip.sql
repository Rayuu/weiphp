...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='行为日志表' AUTO_INCREMENT=1452 ;
...
(1447, 12, 1, 1017458442, 'member', 1, 'admin在2015-09-23 23:24登录了后台', 1, 1443021849),
(1448, 12, 1, 1017458478, 'member', 1, 'admin在2015-09-24 14:09登录了后台', 1, 1443074978),
(1449, 8, 1, 1017458442, 'attribute', 1422, '操作url：/index.php?s=/Admin/Attribute/update.html', 1, 1443078966),
(1450, 12, 1, 1973158510, 'member', 1, 'admin在2015-09-24 17:17登录了后台', 1, 1443086226),
(1451, 12, 1, 1017458478, 'member', 1, 'admin在2015-09-24 21:42登录了后台', 1, 1443102128);
...
CREATE TABLE IF NOT EXISTS `wp_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='插件表' AUTO_INCREMENT=109 ;

--
-- 转存表中的数据 `wp_addons`
--

INSERT INTO `wp_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`, `type`, `cate_id`) VALUES
...
(17, 'Chat', '智能聊天', '通过网络上支持的智能API，实现：天气、翻译、藏头诗、笑话、歌词、计算、域名信息/备案/收录查询、IP查询、手机号码归属、人工智能聊天等功能', 1, '{"tuling_key":"95c38b8a8d87f72269cdbf80908eb699","tuling_url":"http:\\/\\/www.tuling123.com\\/openapi\\/api","simsim_key":"41250a68-3cb5-43c8-9aa2-d7b3caf519b1","simsim_url":"http:\\/\\/sandbox.api.simsimi.com\\/request.p","i9_url":"http:\\/\\/www.xiaojo.com\\/bot\\/chata.php","rand_reply":"\\u6211\\u4eca\\u5929\\u7d2f\\u4e86\\uff0c\\u660e\\u5929\\u518d\\u966a\\u4f60\\u804a\\u5929\\u5427\\r\\n\\u54c8\\u54c8~~\\r\\n\\u4f60\\u8bdd\\u597d\\u591a\\u554a\\uff0c\\u4e0d\\u8ddf\\u4f60\\u804a\\u4e86\\r\\n\\u867d\\u7136\\u4e0d\\u61c2\\uff0c\\u4f46\\u89c9\\u5f97\\u4f60\\u8bf4\\u5f97\\u5f88\\u5bf9"}', '地下凡星', '0.1', 1389454867, 0, 1, 2),
...
(65, 'HelloWorld', '微信入门案例', '这是一个简单的入门案例', 1, 'null', '凡星', '0.1', 1404133803, 0, 1, NULL),
...
(83, 'YouaskService', '你问我答客服系统', '一个支持你问我答,关键词制定客服的客服系统', 1, 'null', '陌路生人', '0.1', 1403947448, 1, 1, 1),
(91, 'AliPlay', '支付宝', '支付宝插件,后台配置支持变量。如：价格：$GOODS["price"].但是配置的变量要和数据库商品信息一致。', 1, '{"group":null}', 'Marvin(柳英伟)', '2.0', 1443075112, 0, 0, NULL),
(92, 'Diy', '万能页面', '可以通过拖拉的方式配置一个3G页面', 1, 'null', '凡星', '0.1', 1443075312, 1, 1, NULL),
(107, 'Hotel', '微酒店', '酒店预定', 1, 'null', '淡然', '1', 1443104302, 1, 1, 4),
(94, 'MoonEating', '进击玉兔', '中秋小游戏插件', 1, '{"title":"\\u8fdb\\u51fb\\u7389\\u5154","cover":"","desc":"\\u8fdb\\u5165\\u6e38\\u620f"}', '豪哥', '1.0', 1443078060, 0, 1, NULL),
(95, 'Love', '表白墙', '微信表白墙插件', 1, '{"title":"\\u8868\\u767d\\u5899","cover":"","desc":"\\u5fae\\u4fe1\\u8868\\u767d\\u5899\\uff0c\\u8bf7\\u52c7\\u6562\\u8bf4\\u51fa\\u4f60\\u7684\\u7231"}', '艾逗笔', '0.1', 1443078391, 1, 1, NULL),
(96, 'Game', '游戏', '微信小游戏插件，汇集各种好玩的小游戏，给你带来一段愉快的休闲娱乐时光~', 1, '{"random":"1"}', '艾逗笔', '1.0', 1443078398, 1, 1, NULL),
(97, 'Jianzhi', '兼职', '微信兼职信息平台', 1, '{"title":"\\u5fae\\u4fe1\\u517c\\u804c\\u4fe1\\u606f\\u5e73\\u53f0","cover":"","desc":"\\u6700\\u5168\\u7684\\u517c\\u804c\\u4fe1\\u606f\\u5e73\\u53f0\\uff0c\\u8ba9\\u4f60\\u8f7b\\u8f7b\\u677e\\u677e\\u627e\\u5230\\u517c\\u804c"}', '艾逗笔', '1.0', 1443078402, 1, 1, NULL),
(98, 'Juhe', '聚合数据', '集成聚合数据（http://www.juhe.cn）平台的功能', 1, '{"stock":"","exchange":"","gold":""}', '凡星', '0.1', 1443078407, 0, 1, NULL),
(99, 'Dg', '点歌', '如果音乐资源足够好，那将秒杀一切手机上在线听歌软件也不是没有可能的', 1, 'null', 'NPC', '0.1', 1443078410, 1, 1, NULL),
(106, 'LostAndFound', '失物招领', '微信失物招领插件', 1, '{"title":"\\u5931\\u7269\\u62db\\u9886","img":"","desc":"\\u4e22\\u5931\\u7269\\u54c1\\uff0c\\u8f7b\\u677e\\u627e\\u56de\\uff0c\\u8bf7\\u70b9\\u51fb\\u6b64\\u5904\\u8fdb\\u5165\\u5fae\\u4fe1\\u5931\\u7269\\u62db\\u9886\\u6a21\\u5757"}', '艾逗笔', '1.0', 1443103015, 0, 1, NULL),
(108, 'Nearby', '附近搜索', '搜索附近商家的插件，使用本插件需申请百度地图API的秘钥http://lbsyun.baidu.com/apiconsole/key', 1, '{"ak":""}', 'zhoufan', '0.1', 1443105891, 0, 1, NULL);
...
CREATE TABLE IF NOT EXISTS `wp_attribute` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='模型属性表' AUTO_INCREMENT=1568 ;
...
(90, 'type', '公众号类型', 'char(10) NOT NULL', 'radio', '0', '', 1, '0:订阅号\r\n1:服务号', 11, 0, 1, 1393718575, 1393718575, '', 3, '', 'regex', '', 3, 'function'),
(91, 'appid', 'AppId', 'varchar(255) NOT NULL', 'string', '', '认证服务号的AppId', 1, '', 11, 0, 1, 1393718830, 1393718735, '', 3, '', 'regex', '', 3, 'function'),
(92, 'secret', 'Secret', 'varchar(255) NOT NULL', 'string', '', '认证服务号的Secret', 1, '', 11, 0, 1, 1393718806, 1393718806, '', 3, '', 'regex', '', 3, 'function'),
...
(651, 'pid', '一级菜单', 'tinyint(2) NULL', 'select', '0', '如果是一级菜单，选择“无”即可', 1, '0:无', 85, 0, 1, 1394519296, 1394518930, '', 3, '', 'regex', '', 3, 'function'),
...
(649, 'keyword', '关联关键词', 'varchar(100) NULL', 'string', '', '关联关键词和关联URL选填一项', 1, '', 85, 0, 1, 1394519232, 1394519054, '', 3, '', 'regex', '', 3, 'function'),
...
(1339, 'keyword', '关键词', 'varchar(100) NOT NULL', 'string', '', '', 1, '', 153, 1, 1, 1399038073, 1396061575, '', 3, '', 'regex', '', 3, 'function'),
(1340, 'title', '标题', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 153, 1, 1, 1396624461, 1396061859, '', 3, '', 'regex', '', 3, 'function'),
(1341, 'intro', '封面简介', 'text NOT NULL', 'textarea', '', '', 1, '', 153, 0, 1, 1396624505, 1396061947, '', 3, '', 'regex', '', 3, 'function'),
(1342, 'mTime', '修改时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 153, 0, 1, 1396624664, 1396624664, '', 3, '', 'regex', 'time', 3, 'function'),
(1343, 'cover', '封面图片', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 1, '', 153, 0, 1, 1396624534, 1396062093, '', 3, '', 'regex', '', 3, 'function'),
(1344, 'cTime', '发布时间', 'int(10) UNSIGNED NOT NULL', 'datetime', '', '', 0, '', 153, 0, 1, 1396624612, 1396075102, '', 3, '', 'regex', 'time', 1, 'function'),
(1345, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 153, 0, 1, 1396602871, 1396602859, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1346, 'url', '访问网址', 'varchar(255) NOT NULL', 'string', '', '为空则自动生成', 0, '', 153, 0, 1, 1398416321, 1397361414, '', 3, '', 'regex', '', 3, 'function'),
(1347, 'is_close', '是否关闭', 'tinyint(2) NOT NULL', 'bool', '0', '关闭后用户不能再访问该页面', 1, '0:开启\r\n1:关闭', 153, 0, 1, 1397361841, 1397361510, '', 3, '', 'regex', '', 3, 'function'),
(1348, 'need_login', '游客访问', 'tinyint(2) NOT NULL', 'bool', '0', '', 1, '0:允许\r\n1:禁止', 153, 0, 1, 1397361769, 1397361769, '', 3, '', 'regex', '', 3, 'function'),
(1349, 'layout', '页面参数', 'text NOT NULL', 'textarea', '', '', 0, '', 153, 0, 1, 1397474846, 1397474846, '', 3, '', 'regex', '', 3, 'function'),
(1350, 'view_count', '浏览数', 'int(10) UNSIGNED NOT NULL', 'num', '0', '', 0, '', 153, 0, 1, 1397475862, 1397475862, '', 3, '', 'regex', '', 3, 'function'),
(1351, 'module', '模块名', 'varchar(255) NOT NULL', 'string', 'Diy', '页面所属的模块', 0, '', 153, 0, 1, 1398350642, 1398350642, '', 3, '', 'regex', '', 3, 'function'),
(1520, 'image2', '幻灯片图片2', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 0, '', 175, 0, 1, 1407375738, 1407364876, '', 3, '', 'regex', '', 3, 'function'),
(1521, 'image1', '幻灯片图片1', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 0, '', 175, 0, 1, 1407375747, 1407364861, '', 3, '', 'regex', '', 3, 'function'),
(1522, 'about', '酒店介绍', 'text NOT NULL', 'editor', '', '', 0, '', 175, 0, 1, 1407375757, 1407364820, '', 3, '', 'regex', '', 3, 'function'),
(1523, 'description', '酒店简介', 'text NOT NULL', 'textarea', '', '', 1, '', 175, 0, 1, 1407375773, 1406601618, '', 3, '', 'regex', '', 3, 'function'),
(1524, 'posj', '坐标（经度）', 'int(10) NOT NULL', 'num', '', '', 1, '', 175, 0, 1, 1406601567, 1406601567, '', 3, '', 'regex', '', 3, 'function'),
(1525, 'image4', '幻灯片图片4', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 0, '', 175, 0, 1, 1407375721, 1407364906, '', 3, '', 'regex', '', 3, 'function'),
(1526, 'image5', '幻灯片图片5', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 0, '', 175, 0, 1, 1407375714, 1407364921, '', 3, '', 'regex', '', 3, 'function'),
(1527, 'startdate', '入住日期', 'int(8) NOT NULL', 'num', '', '', 1, '', 176, 1, 1, 1406637301, 1406637301, '', 3, '', 'regex', '', 3, 'function'),
(1528, 'openid', '客户openid', 'varchar(255) NOT NULL', 'string', '', '', 4, '', 176, 1, 1, 1406637066, 1406637066, '', 3, '', 'regex', '', 3, 'function'),
(1529, 'price', '价格', 'int(10) NOT NULL', 'num', '', '', 1, '', 176, 1, 1, 1406637102, 1406637102, '', 3, '', 'regex', '', 3, 'function'),
(1530, 'num', '房间数', 'int(10) NOT NULL', 'num', '', '', 1, '', 176, 1, 1, 1406637144, 1406637144, '', 3, '', 'regex', '', 3, 'function'),
(1531, 'name', '姓名', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 176, 1, 1, 1406637219, 1406637219, '', 3, '', 'regex', '', 3, 'function'),
(1532, 'mTime', '修改时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 176, 0, 1, 1396624664, 1396624664, '', 3, '', 'regex', 'time', 3, 'function'),
(1533, 'time', '预定时间', 'int(11) NOT NULL', 'num', '', '', 1, '', 176, 1, 1, 1406637269, 1406637269, '', 3, '', 'regex', '', 3, 'function'),
(1534, 'cTime', '发布时间', 'int(10) UNSIGNED NOT NULL', 'datetime', '', '', 0, '', 176, 0, 1, 1396624612, 1396075102, '', 3, '', 'regex', 'time', 1, 'function'),
(1535, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 176, 0, 1, 1396602871, 1396602859, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1485, 'type', '类型', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 172, 0, 1, 1405499733, 1405499733, '', 3, '', 'regex', '', 3, 'function'),
(1493, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 173, 0, 1, 1405499267, 1405499267, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1487, 'address', '地点', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 172, 0, 1, 1405499766, 1405499766, '', 3, '', 'regex', '', 3, 'function'),
(1488, 'info', '详情', 'text NOT NULL', 'textarea', '', '', 1, '', 172, 0, 1, 1405499784, 1405499784, '', 3, '', 'regex', '', 3, 'function'),
(1489, 'pic', '物品图片', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 0, '', 172, 0, 1, 1405499852, 1405499852, '', 3, '', 'regex', '', 3, 'function'),
(1490, 'state', '物品状态', 'int(10) NOT NULL', 'num', '', '', 0, '', 172, 0, 1, 1405500108, 1405500108, '', 3, '', 'regex', '', 3, 'function'),
(1491, 'username', '用户姓名', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 172, 0, 1, 1405599032, 1405599032, '', 3, '', 'regex', '', 3, 'function'),
(1492, 'phone', '用户电话', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 172, 0, 1, 1405599050, 1405599050, '', 3, '', 'regex', '', 3, 'function'),
(1494, 'uid', '用户ID', 'int(10) NOT NULL', 'num', '', '', 0, '', 173, 0, 1, 1405499307, 1405499307, '', 3, '', 'regex', 'get_mid', 1, 'function'),
(1495, 'cTime', '创建时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 173, 0, 1, 1405499355, 1405499355, '', 3, '', 'regex', 'time', 1, 'function'),
(1496, 'username', '用户姓名', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 173, 0, 1, 1405499398, 1405499398, '', 3, '', 'regex', '', 3, 'function'),
(1497, 'phone', '用户电话', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 173, 0, 1, 1405499416, 1405499416, '', 3, '', 'regex', '', 3, 'function'),
(1486, 'title', '物品名称', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 172, 0, 1, 1405499749, 1405499749, '', 3, '', 'regex', '', 3, 'function'),
(1499, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 174, 0, 1, 1405499494, 1405499494, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1500, 'uid', '用户ID', 'int(10) NOT NULL', 'num', '', '', 0, '', 174, 0, 1, 1405499547, 1405499547, '', 3, '', 'regex', 'get_mid', 1, 'function'),
(1501, 'cTime', '发布时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 174, 0, 1, 1405499717, 1405499717, '', 3, '', 'regex', 'time', 1, 'function'),
(1502, 'type', '类型', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 174, 0, 1, 1405499733, 1405499733, '', 3, '', 'regex', '', 3, 'function'),
(1503, 'title', '物品名称', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 174, 0, 1, 1405499749, 1405499749, '', 3, '', 'regex', '', 3, 'function'),
(1504, 'address', '地点', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 174, 0, 1, 1405499766, 1405499766, '', 3, '', 'regex', '', 3, 'function'),
(1505, 'info', '详情', 'text NOT NULL', 'textarea', '', '', 1, '', 174, 0, 1, 1405499784, 1405499784, '', 3, '', 'regex', '', 3, 'function'),
(1506, 'pic', '物品图片', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 0, '', 174, 0, 1, 1405499852, 1405499852, '', 3, '', 'regex', '', 3, 'function'),
(1507, 'state', '物品状态', 'int(10) NOT NULL', 'num', '', '', 0, '', 174, 0, 1, 1405500108, 1405500108, '', 3, '', 'regex', '', 3, 'function'),
(1508, 'username', '用户姓名', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 174, 0, 1, 1405599032, 1405599032, '', 3, '', 'regex', '', 3, 'function'),
(1509, 'phone', '用户电话', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 174, 0, 1, 1405599050, 1405599050, '', 3, '', 'regex', '', 3, 'function'),
(1510, 'sname', '酒店简称', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 175, 0, 1, 1406601181, 1406601181, '', 3, '', 'regex', '', 3, 'function'),
(1511, 'cTime', '发布时间', 'int(10) UNSIGNED NOT NULL', 'datetime', '', '', 0, '', 175, 0, 1, 1396624612, 1396075102, '', 3, '', 'regex', 'time', 1, 'function'),
(1512, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 175, 0, 1, 1396602871, 1396602859, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1513, 'posw', '坐标(纬度)', 'int(10) NOT NULL', 'num', '', '', 1, '', 175, 0, 1, 1406601588, 1406601588, '', 3, '', 'regex', '', 3, 'function'),
(1514, 'tel', '酒店电话', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 175, 1, 1, 1406601663, 1406601226, '', 3, '', 'regex', '', 3, 'function'),
(1515, 'image', '酒店图片', 'int(10) UNSIGNED', 'picture', '', '', 1, '', 175, 0, 1, 1406603213, 1396062093, '', 3, '', 'regex', '', 3, 'function'),
(1516, 'mTime', '修改时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 175, 0, 1, 1396624664, 1396624664, '', 3, '', 'regex', 'time', 3, 'function'),
(1517, 'address', '地址', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 175, 1, 1, 1406601635, 1406601255, '', 3, '', 'regex', '', 3, 'function'),
(1518, 'name', '酒店名称', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 175, 1, 1, 1406601148, 1396061859, '', 3, '', 'regex', '', 3, 'function'),
(1519, 'image3', '幻灯片图片3', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 0, '', 175, 0, 1, 1407375729, 1407364891, '', 3, '', 'regex', '', 3, 'function'),
(1390, 'phone', '电话号码', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 159, 0, 1, 1406349162, 1406349162, '', 3, '', 'regex', '', 3, 'function'),
(1391, 'nickname', '表白者', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 159, 0, 1, 1405751850, 1405751850, '', 3, '', 'regex', '', 3, 'function'),
(1392, 'content', '表白内容', 'text NOT NULL', 'textarea', '', '', 1, '', 159, 0, 1, 1405751825, 1405751825, '', 3, '', 'regex', '', 3, 'function'),
(1393, 'lover', '表白对象', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 159, 0, 1, 1405751804, 1405751804, '', 3, '', 'regex', '', 3, 'function'),
(1394, 'cTime', '发布时间', 'int(10) NOT NULL', 'datetime', '', '', 1, '', 159, 0, 1, 1405751773, 1405751773, '', 3, '', 'regex', 'time', 1, 'function'),
(1395, 'openid', '用户UI', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 159, 0, 1, 1405751742, 1405751742, '', 3, '', 'regex', 'get_mid', 1, 'function'),
(1396, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 159, 0, 1, 1405752400, 1405751694, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1397, 'state', '表白状态', 'int(10) NOT NULL', 'radio', '2', '', 1, '0:表白失败\r\n1:表白成功\r\n2:表白ing', 159, 0, 1, 1406353931, 1406353472, '', 3, '', 'regex', '', 3, 'function'),
(1398, 'reply', '对象反馈', 'text NOT NULL', 'textarea', '', '', 1, '', 159, 0, 1, 1406353506, 1406353506, '', 3, '', 'regex', '', 3, 'function'),
(1399, 'favourid', '点赞数', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 159, 0, 1, 1406814622, 1406814622, '', 3, '', 'regex', '', 3, 'function'),
(1400, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 160, 0, 1, 1406730452, 1406730402, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1401, 'openid', '用户ID', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 160, 0, 1, 1406730435, 1406730435, '', 3, '', 'regex', 'get_mid', 1, 'function'),
(1402, 'content', '评论内容', 'text NOT NULL', 'textarea', '', '', 1, '', 160, 0, 1, 1406730536, 1406730536, '', 3, '', 'regex', '', 3, 'function'),
(1403, 'cTime', '创建时间', 'int(10) NOT NULL', 'datetime', '', '', 1, '', 160, 0, 1, 1406730562, 1406730562, '', 3, '', 'regex', 'time', 1, 'function'),
(1404, 'loveId', '表白内容关联ID', 'int(10) NOT NULL', 'num', '', '', 0, '', 160, 0, 1, 1406730610, 1406730610, '', 3, '', 'regex', '', 3, 'function'),
(1405, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 161, 0, 1, 1407671573, 1407671573, '', 3, '', 'regex', 'get_token', 3, 'function'),
(1406, 'cTime', '创建时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 161, 0, 1, 1407671619, 1407671619, '', 3, '', 'regex', 'time', 3, 'function'),
(1407, 'title', '游戏名', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 161, 0, 1, 1407671644, 1407671644, '', 3, '', 'regex', '', 3, 'function'),
(1408, 'desc', '游戏玩法', 'text NOT NULL', 'textarea', '', '', 1, '', 161, 0, 1, 1407671692, 1407671692, '', 3, '', 'regex', '', 3, 'function'),
(1409, 'cover', '游戏封面', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 1, '', 161, 0, 1, 1407671721, 1407671721, '', 3, '', 'regex', '', 3, 'function'),
(1410, 'url', '游戏地址', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 161, 0, 1, 1407671744, 1407671744, '', 3, '', 'regex', '', 3, 'function'),
(1411, 'token', 'Tokn', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 162, 0, 1, 1407806481, 1407806481, '', 3, '', 'regex', 'get_token', 3, 'function'),
(1412, 'openid', '用户openid', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 162, 0, 1, 1407806515, 1407806515, '', 3, '', 'regex', 'get_openid', 3, 'function'),
(1413, 'cTime', '发布时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 162, 0, 1, 1407806556, 1407806556, '', 3, '', 'regex', 'time', 3, 'function'),
(1414, 'title', '标题', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 162, 0, 1, 1407806581, 1407806581, '', 3, '', 'regex', '', 3, 'function'),
(1415, 'content', '内容', 'text NOT NULL', 'textarea', '', '', 1, '', 162, 0, 1, 1407806602, 1407806602, '', 3, '', 'regex', '', 3, 'function'),
(1416, 'contact', '联系方式', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 162, 0, 1, 1407806637, 1407806637, '', 3, '', 'regex', '', 3, 'function');
INSERT INTO `wp_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
(1417, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 163, 0, 1, 1407809622, 1407809622, '', 3, '', 'regex', 'get_token', 3, 'function'),
(1418, 'openid', '用户openid', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 163, 0, 1, 1407809675, 1407809675, '', 3, '', 'regex', 'get_openid', 3, 'function'),
(1419, 'cTime', '评论时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 163, 0, 1, 1407809712, 1407809712, '', 3, '', 'regex', 'time', 3, 'function'),
(1420, 'j_id', '兼职信息id', 'int(10) NOT NULL', 'num', '', '', 1, '', 163, 0, 1, 1407809759, 1407809759, '', 3, '', 'regex', '', 3, 'function'),
(1421, 'comment', '评论内容', 'text NOT NULL', 'textarea', '', '', 1, '', 163, 0, 1, 1407809786, 1407809786, '', 3, '', 'regex', '', 3, 'function'),
(1422, 'mydesc', '个人简介', 'text NOT NULL', 'textarea', '', '', 1, '', 89, 0, 1, 1443078966, 1443078966, '', 3, '', 'regex', '', 3, 'function'),
(1498, 'address', '用户地址', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 173, 0, 1, 1405499441, 1405499441, '', 3, '', 'regex', '', 3, 'function'),
(1483, 'uid', '用户ID', 'int(10) NOT NULL', 'num', '', '', 0, '', 172, 0, 1, 1405499547, 1405499547, '', 3, '', 'regex', 'get_mid', 1, 'function'),
(1484, 'cTime', '发布时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 172, 0, 1, 1405499717, 1405499717, '', 3, '', 'regex', 'time', 1, 'function'),
(1482, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 172, 0, 1, 1405499494, 1405499494, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1552, 'floor', '楼层', 'int(10) NOT NULL', 'num', '', '', 1, '', 177, 1, 1, 1406630102, 1406630102, '', 3, '', 'regex', '', 3, 'function'),
(1551, 'name', '房间名（房号）', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 177, 1, 1, 1406607312, 1406607312, '', 3, '', 'regex', '', 3, 'function'),
(1545, 'hid', '所属酒店', 'int(10) NOT NULL', 'num', '', '', 4, '', 177, 1, 1, 1406642293, 1406607371, '', 3, '', 'regex', '', 3, 'function'),
(1550, 'roomtype', '房型', 'int(10) NOT NULL', 'select', '', '', 1, ':get_roomtype()', 177, 1, 1, 1406630318, 1406607606, '', 3, '', 'regex', '', 3, 'function'),
(1549, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 177, 0, 1, 1396602871, 1396602859, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1548, 'cTime', '发布时间', 'int(10) UNSIGNED NOT NULL', 'datetime', '', '', 0, '', 177, 0, 1, 1396624612, 1396075102, '', 3, '', 'regex', 'time', 1, 'function'),
(1547, 'image', '图片', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 1, '', 177, 0, 1, 1406630190, 1396062093, '', 3, '', 'regex', '', 3, 'function'),
(1546, 'mTime', '修改时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 177, 0, 1, 1396624664, 1396624664, '', 3, '', 'regex', 'time', 3, 'function'),
(1544, 'note', '房间说明', 'text NOT NULL', 'textarea', '', '', 1, '', 177, 0, 1, 1406607639, 1406607639, '', 3, '', 'regex', '', 3, 'function'),
(1541, 'printed', '已打印', 'tinyint(1) unsigned NOT NULL', 'num', '0', '', 1, '', 176, 0, 1, 1406637488, 1406637488, '', 3, '', 'regex', '', 3, 'function'),
(1543, 'roomtype', '房型', 'int(10) NOT NULL', 'select', '', '', 1, ':get_roomtype()', 176, 0, 1, 1406637867, 1406637849, '', 3, '', 'regex', '', 3, 'function'),
(1542, 'status', '状态', 'tinyint(1) unsigned NOT NULL', 'num', '1', '', 1, '', 176, 1, 1, 1406637519, 1406637519, '', 3, '', 'regex', '', 3, 'function'),
(1540, 'orderid', '单号', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 176, 0, 1, 1406637434, 1406637434, '', 3, '', 'regex', '', 3, 'function'),
(1539, 'paid', '支付序号', 'int(10) NOT NULL', 'num', '', '', 1, '', 176, 0, 1, 1406637402, 1406637402, '', 3, '', 'regex', '', 3, 'function'),
(1536, 'hid', '酒店ID', 'int(10) NOT NULL', 'num', '', '', 4, '', 176, 1, 1, 1406637007, 1406637007, '', 3, '', 'regex', '', 3, 'function'),
(1538, 'enddate', '退房日期', 'int(8) NOT NULL', 'num', '', '', 1, '', 176, 1, 1, 1406637320, 1406637320, '', 3, '', 'regex', '', 3, 'function'),
(1537, 'tel', '电话', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 176, 1, 1, 1406637232, 1406637232, '', 3, '', 'regex', '', 3, 'function'),
(1553, 'price', '门市价', 'int(10) NOT NULL', 'num', '', '', 1, '', 178, 1, 1, 1406606460, 1406606460, '', 3, '', 'regex', '', 3, 'function'),
(1554, 'price1', '会员价1', 'int(10) NOT NULL', 'num', '', '', 1, '', 178, 1, 1, 1406606477, 1406606477, '', 3, '', 'regex', '', 3, 'function'),
(1555, 'price2', '会员价2', 'int(10) NOT NULL', 'num', '0', '', 1, '', 178, 0, 1, 1406606554, 1406606491, '', 3, '', 'regex', '', 3, 'function'),
(1556, 'price3', '会员价3', 'int(10) NOT NULL', 'num', '0', '', 1, '', 178, 0, 1, 1406606548, 1406606508, '', 3, '', 'regex', '', 3, 'function'),
(1557, 'mTime', '修改时间', 'int(10) NOT NULL', 'datetime', '', '', 0, '', 178, 0, 1, 1396624664, 1396624664, '', 3, '', 'regex', 'time', 3, 'function'),
(1558, 'image', '图片', 'int(10) UNSIGNED NOT NULL', 'picture', '', '', 1, '', 178, 0, 1, 1406606314, 1396062093, '', 3, '', 'regex', '', 3, 'function'),
(1559, 'price4', '会员价4', 'int(10) NOT NULL', 'num', '0', '', 1, '', 178, 0, 1, 1406606541, 1406606521, '', 3, '', 'regex', '', 3, 'function'),
(1560, 'cTime', '发布时间', 'int(10) UNSIGNED NOT NULL', 'datetime', '', '', 0, '', 178, 0, 1, 1396624612, 1396075102, '', 3, '', 'regex', 'time', 1, 'function'),
(1561, 'token', 'Token', 'varchar(255) NOT NULL', 'string', '', '', 0, '', 178, 0, 1, 1396602871, 1396602859, '', 3, '', 'regex', 'get_token', 1, 'function'),
(1562, 'name', '房型名称', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 178, 1, 1, 1406606343, 1406606343, '', 3, '', 'regex', '', 3, 'function'),
(1563, 'price5', '会员价5', 'int(10) NOT NULL', 'num', '0', '', 1, '', 178, 0, 1, 1406606533, 1406606533, '', 3, '', 'regex', '', 3, 'function'),
(1564, 'num', '可入住人数', 'int(10) NOT NULL', 'num', '', '', 1, '', 178, 0, 1, 1406606593, 1406606593, '', 3, '', 'regex', '', 3, 'function'),
(1565, 'note', '房型备注', 'varchar(255) NOT NULL', 'string', '', '', 1, '', 178, 0, 1, 1406606617, 1406606617, '', 3, '', 'regex', '', 3, 'function'),
(1566, 'roomnum', '房间数', 'int(10) NOT NULL', 'num', '', '', 1, '', 178, 0, 1, 1406606644, 1406606644, '', 3, '', 'regex', '', 3, 'function'),
(1567, 'hid', '酒店', 'int(10) NOT NULL', 'num', '', '', 4, '', 178, 1, 1, 1406641021, 1406641021, '', 3, '', 'regex', '', 3, 'function');
...
INSERT INTO `wp_card_member` (`id`, `uid`, `username`, `phone`, `number`, `cTime`, `token`) VALUES
(35, 366, '哈哈', '123', '80001', 1443102368, 'gh_0edc27007a5f');
...
--
-- 转存表中的数据 `wp_common_category_group`
--
...
(1, 'WEB_SITE_TITLE', 1, '网站标题', 1, '', '网站标题前台显示标题', 1378898976, 1379235274, 1, '校园VIP', 0),
(2, 'WEB_SITE_DESCRIPTION', 2, '网站描述', 1, '', '网站搜索引擎描述', 1378898976, 1379235841, 1, '校园VIP', 1),
(3, 'WEB_SITE_KEYWORD', 2, '网站关键字', 1, '', '网站搜索引擎关键字', 1378898976, 1381390100, 1, '校园VIP,ThinkPHP,OneThink', 8),
...
(46, 'SYSTEM_UPDATRE_VERSION', 0, '系统升级最新版本号', 4, '', '记录当前系统的版本号，这是与官方比较是否有升级包的唯一标识，不熟悉者只勿改变其数值', 1393764702, 1394337646, 1, '20140826', 0),
(47, 'FOLLOW_YOUKE_UID', 0, '粉丝游客ID', 0, '', '', 1398927704, 1398927704, 1, '-3380', 0),
...
(50, 'COPYRIGHT', 1, '版权信息', 1, '', '', 1401018910, 1401018910, 1, '校园VIP 版权所有', 3),
...
--
-- 转存表中的数据 `wp_credit_data`
--

INSERT INTO `wp_credit_data` (`id`, `uid`, `credit_name`, `experience`, `score`, `cTime`, `admin_uid`, `token`) VALUES
(662, -3350, 'chat', 0, 0, 1443071364, 0, 'gh_5f4db4683ba9'),
(663, -3352, 'chat', 0, 0, 1443072216, 0, 'gh_5f4db4683ba9'),
(664, -3353, 'chat', 0, 0, 1443074519, 0, 'gh_27fae299605f'),
(665, -3354, 'custom_reply', 0, 0, 1443074590, 0, 'gh_27fae299605f'),
(666, -3368, 'unsubscribe', -10, -10, 1443078584, 0, 'gh_27fae299605f'),
(667, 365, 'subscribe', 10, 10, 1443078633, 0, 'gh_27fae299605f'),
(668, 365, 'unsubscribe', -10, -10, 1443078698, 0, 'gh_27fae299605f'),
(669, 365, 'custom_reply', 0, 0, 1443079673, 0, 'gh_27fae299605f'),
(670, 365, 'chat', 0, 0, 1443081141, 0, 'gh_27fae299605f'),
(671, 365, 'chat', 0, 0, 1443081699, 0, 'gh_27fae299605f'),
(672, 365, 'chat', 0, 0, 1443083268, 0, 'gh_27fae299605f'),
(673, -3374, 'chat', 0, 0, 1443102303, 0, 'gh_0edc27007a5f'),
(674, 366, 'card_bind', 0, 0, 1443102368, 0, 'gh_0edc27007a5f'),
(675, -3376, 'chat', 0, 0, 1443103193, 0, 'gh_5f4db4683ba9'),
(676, -3377, 'custom_reply', 0, 0, 1443103796, 0, 'gh_5f4db4683ba9'),
(677, -3378, 'chat', 0, 0, 1443103804, 0, 'gh_5f4db4683ba9'),
(678, 365, 'chat', 0, 0, 1443104508, 0, 'gh_27fae299605f'),
(679, 365, 'chat', 0, 0, 1443104980, 0, 'gh_27fae299605f');
...
(20, '你好', 0, '你好', 0, 0, 'gh_5f4db4683ba9'),
(21, '你好', 0, '你好啊', 0, 0, 'gh_27fae299605f');
...
--
-- 转存表中的数据 `wp_extensions`
--

INSERT INTO `wp_extensions` (`id`, `keyword_type`, `api_token`, `cTime`, `api_url`, `output_format`, `keyword_filter`, `keyword`, `token`) VALUES
(7, 3, 'weixin', 1443075981, 'http://wx429.sinaapp.com/index3.php', 0, 0, '成绩 课表 校车 校历 绑定 解绑', 'gh_27fae299605f');
...
CREATE TABLE IF NOT EXISTS `wp_follow` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  ...
  `mydesc` text NOT NULL COMMENT '个人简介',
  PRIMARY KEY (`id`)
...
INSERT INTO `wp_follow` (`id`, `token`, `openid`, `nickname`, `sex`, `city`, `province`, `country`, `language`, `headimgurl`, `subscribe_time`, `mobile`, `status`, `score`, `experience`, `mTime`, `mydesc`) VALUES
(365, 'gh_27fae299605f', 'oG1VFuC3h-uNaPoec8TSfKCQbnA0', '哈哈', 1, '', '', '', 'zh_CN', '', 1443078633, '11111', 2, 0, 0, 1443079752, ''),
(366, 'gh_0edc27007a5f', 'oIOCHs500xC_ytopdq-45oGEg5c8', '', 0, '', '', '', 'zh_CN', '', 1443102317, '', 3, 0, 0, 0, '');
...
CREATE TABLE IF NOT EXISTS `wp_forum` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` varchar(255) NOT NULL COMMENT '标题',
  `uid` int(10) DEFAULT '0' COMMENT '用户ID',
...
INSERT INTO `wp_game` (`id`, `token`, `cTime`, `title`, `desc`, `cover`, `url`) VALUES
(1, 'gh_a16860f75a5c', 1407672510, '最强眼力', '试试看你的眼力有多强', 389, 'http://1.chinspro.sinaapp.com/%E6%9C%80%E5%BC%BA%E7%9C%BC%E5%8A%9B/index.html'),
(2, 'gh_a16860f75a5c', 1407672835, '危险游戏', '', 390, 'http://m.edianyou.com/h5game/Danger%20Ranger.html#rd'),
(3, 'gh_a16860f75a5c', 1407673241, '一个都不能死', '', 391, 'http://run.app100725914.twsapp.com/index.php?openid=1A5127D7691F6098331D7D0D8F9BBE2E&openkey=5B50BCB'),
(4, 'gh_a16860f75a5c', 1407673709, '围住神经猫', '', 392, 'http://u.ali213.net/games/shenjingcat/index.html?game_code=196&bs=wx'),
(5, 'gh_a16860f75a5c', 1407674113, '2048', '', 393, 'http://gabrielecirulli.github.io/2048/'),
(6, 'gh_a16860f75a5c', 1407674457, '八戒吃月饼', '', 394, 'http://www.hlo.cc/weixin/bajieyb/');
...
(17, 'weixin', '微信插件必须加载的钩子', 1, 1388810858, 'Vote,Chat,Wecome,UserCenter,Robot,Suggestions,Extensions,Card,WeiSite,Hitegg,Leaflets,CustomReply,Forms,Survey,Exam,Test,Diy,Shop,CustomMenu,Coupon,Scratch,Juhe,Tongji,HelloWorld,MoonEating,Love,Game,Jianzhi,Dg,LostAndFound,Hotel,Nearby'),
(18, 'cascade', '级联菜单', 1, 1398694587, 'Cascade'),
(19, 'page_diy', '万能页面的钩子', 1, 1399040364, 'Diy'),
(20, 'indexAliPlay', '支付宝钩子', 1, 1443075112, 'indexAliPlay,AliPlay');
...
CREATE TABLE IF NOT EXISTS `wp_hotel` (
  ...
  `image` int(10) unsigned DEFAULT NULL COMMENT '酒店图片',
  `mTime` int(10) NOT NULL COMMENT '修改时间',
...
INSERT INTO `wp_hotel` (`id`, `sname`, `cTime`, `token`, `posw`, `tel`, `image`, `mTime`, `address`, `name`, `image3`, `image2`, `image1`, `about`, `description`, `posj`, `image4`, `image5`) VALUES
(1, '', 1443104474, 'gh_27fae299605f', 88, '0931-888888', 369, 1443104474, '甘肃省兰州市', '民大之星', 0, 0, 0, '', '民大之星', 88, 0, 0);
...
--
-- 转存表中的数据 `wp_hotel_room_type`
--

INSERT INTO `wp_hotel_room_type` (`id`, `price`, `price1`, `price2`, `price3`, `mTime`, `image`, `price4`, `cTime`, `token`, `name`, `price5`, `num`, `note`, `roomnum`, `hid`) VALUES
(1, 198, 188, 0, 0, 1443104583, 0, 0, 1443104583, 'gh_27fae299605f', '标准间', 0, 2, '', 5, 1);
...
INSERT INTO `wp_jianzhi` (`id`, `token`, `openid`, `cTime`, `title`, `content`, `contact`) VALUES
(1, 'gh_27fae299605f', 'oG1VFuC3h-uNaPoec8TSfKCQbnA0', 1443081661, '发传单', '100/天', 'QQ291070726');

-- --------------------------------------------------------

--
-- 表的结构 `wp_jianzhi_comment`
--
...
INSERT INTO `wp_keyword` (`id`, `keyword`, `token`, `addon`, `aim_id`, `cTime`, `keyword_length`, `keyword_type`, `extra_text`, `extra_int`, `request_count`) VALUES
(457, '你好', 'gh_5f4db4683ba9', 'CustomReply', 20, 1443074497, 6, 0, 'custom_reply_text', 0, 1),
(458, '你好', 'gh_27fae299605f', 'CustomReply', 21, 1443074584, 6, 0, 'custom_reply_text', 0, 2),
(480, '刮刮卡', 'gh_27fae299605f', 'Scratch', 22, 1443088662, 9, 0, '', 0, 0),
(461, '成绩', 'gh_27fae299605f', 'Extensions', 7, 1443075981, 6, 3, '', 0, 2),
(462, '课表', 'gh_27fae299605f', 'Extensions', 7, 1443075981, 6, 3, '', 0, 1),
(463, '校车', 'gh_27fae299605f', 'Extensions', 7, 1443075981, 6, 3, '', 0, 1),
(464, '校历', 'gh_27fae299605f', 'Extensions', 7, 1443075981, 6, 3, '', 0, 0),
(465, '绑定', 'gh_27fae299605f', 'Extensions', 7, 1443075981, 6, 3, '', 0, 0),
(466, '解绑', 'gh_27fae299605f', 'Extensions', 7, 1443075981, 6, 3, '', 0, 0),
(467, '股票', '0', 'Juhe', 0, 1393210483, 2, 0, '', 0, 0),
(468, '黄金', '0', 'Juhe', 0, 1393210483, 2, 0, '', 0, 0),
(469, '货币汇率', '0', 'Juhe', 0, 1393210483, 4, 0, '', 0, 0),
(470, '点歌', '0', 'Dg', 0, 1406330808, 6, 1, '', 0, 0),
(473, '大转盘', 'gh_27fae299605f', 'Xydzp', 1, 1443083568, 9, 0, '', 0, 1);
...
CREATE TABLE IF NOT EXISTS `wp_love` (
  ...
  `cTime` int(10) NOT NULL COMMENT '发布时间',
  `openid` varchar(255) NOT NULL COMMENT '用户UI',
  `token` varchar(255) NOT NULL COMMENT 'Token',
...
INSERT INTO `wp_member` (`uid`, `nickname`, `sex`, `birthday`, `qq`, `score`, `login`, `reg_ip`, `reg_time`, `last_login_ip`, `last_login_time`, `status`, `public_count`, `extra_field`) VALUES
(1, 'admin', 0, '0000-00-00', '', 0, 13, 0, 1443021605, 1017458442, 1443103345, 1, NULL, NULL),
(363, 'lq767925949', 0, '0000-00-00', '', 0, 1, 1971854151, 1443023816, 1971854151, 1443023816, 1, NULL, NULL),
(364, '头上长草', 0, '0000-00-00', '', 0, 1, 2090394631, 1443023873, 2090394631, 1443023873, 1, NULL, NULL),
(367, '110', 0, '0000-00-00', '', 0, 1, 0, 0, 1939496078, 1443103364, 1, NULL, NULL);
...
(109, NULL, 'Lhoom芷念', 'gh_5f4db4683ba9 ', 'Lhoom56', '', '367', '', '{"Chat":{"tuling_key":"95c38b8a8d87f72269cdbf80908eb699","tuling_url":"http:\\/\\/www.tuling123.com\\/openapi\\/api","simsim_key":"41250a68-3cb5-43c8-9aa2-d7b3caf519b1","simsim_url":"http:\\/\\/sandbox.api.simsimi.com\\/request.p","i9_url":"http:\\/\\/www.xiaojo.com\\/bot\\/chata.php","rand_reply":"\\u6211\\u4eca\\u5929\\u7d2f\\u4e86\\uff0c\\u660e\\u5929\\u518d\\u966a\\u4f60\\u804a\\u5929\\u5427\\r\\n\\u54c8\\u54c8~~\\r\\n\\u4f60\\u8bdd\\u597d\\u591a\\u554a\\uff0c\\u4e0d\\u8ddf\\u4f60\\u804a\\u4e86\\r\\n\\u867d\\u7136\\u4e0d\\u61c2\\uff0c\\u4f46\\u89c9\\u5f97\\u4f60\\u8bf4\\u5f97\\u5f88\\u5bf9"}}', '', 'gh_5f4db4683ba9 ', 0, '0', 'wx13aa3dbc67c59ec3', '87d66384047283e50ff3a4169cc69e91', 0),
(107, NULL, '乌巢禅师', 'gh_27fae299605f', 'wuchaochanshi', '', '365', '', '{"UserCenter":{"need_bind":"1","bind_start":"0","jumpurl":""},"Leaflets":{"title":"\\u6821\\u56edVIP","img":"366","info":"","copyright":"\\u00a92015 \\u6821\\u56edVIP\\u5b98\\u65b9\\u5fae\\u4fe1\\u516c\\u4f17\\u53f7\\u7248\\u6743\\u6240\\u6709"},"Chat":{"tuling_key":"95c38b8a8d87f72269cdbf80908eb699","tuling_url":"http:\\/\\/www.tuling123.com\\/openapi\\/api","simsim_key":"41250a68-3cb5-43c8-9aa2-d7b3caf519b1","simsim_url":"http:\\/\\/sandbox.api.simsimi.com\\/request.p","i9_url":"http:\\/\\/www.xiaojo.com\\/bot\\/chata.php","rand_reply":"\\u6211\\u4eca\\u5929\\u7d2f\\u4e86\\uff0c\\u660e\\u5929\\u518d\\u966a\\u4f60\\u804a\\u5929\\u5427\\r\\n\\u54c8\\u54c8~~\\r\\n\\u4f60\\u8bdd\\u597d\\u591a\\u554a\\uff0c\\u4e0d\\u8ddf\\u4f60\\u804a\\u4e86\\r\\n\\u867d\\u7136\\u4e0d\\u61c2\\uff0c\\u4f46\\u89c9\\u5f97\\u4f60\\u8bf4\\u5f97\\u5f88\\u5bf9"},"Card":{"background":"1","bg":"","title":"\\u6821\\u56edVIP\\u4f1a\\u5458\\u5361","length":"80001","instruction":"1\\u3001\\u606d\\u559c\\u60a8\\u6210\\u4e3a\\u6821\\u56edVIP\\u4f1a\\u5458;\\r\\n2\\u3001\\u7ed3\\u5e10\\u65f6\\u8bf7\\u51fa\\u793a\\u6b64\\u5361\\uff0c\\u51ed\\u6b64\\u5361\\u53ef\\u4eab\\u53d7\\u4f1a\\u5458\\u4f18\\u60e0;\\r\\n3\\u3001\\u6b64\\u5361\\u6700\\u7ec8\\u89e3\\u91ca\\u6743\\u5f52\\u6821\\u56edVIP\\u6240\\u6709","address":"","phone":"","url":"","background_custom":""},"Jianzhi":{"title":"\\u4e8c\\u624b\\u4ea4\\u6613\\u5e73\\u53f0","cover":"","desc":"\\u6700\\u5168\\u7684\\u4e8c\\u624b\\u4ea4\\u6613\\u5e73\\u53f0\\u3002"},"Wemall":{"title":"\\u70b9\\u51fb\\u8fdb\\u5165\\u9996\\u9875","cover":"","info":"","background":"","code":"","template_index":"default","template_footer":"V1","template_detail":"V1"},"LostAndFound":{"title":"\\u5931\\u7269\\u62db\\u9886","img":"","desc":"\\u4e22\\u5931\\u7269\\u54c1\\uff0c\\u8f7b\\u677e\\u627e\\u56de\\uff0c\\u8bf7\\u70b9\\u51fb\\u6b64\\u5904\\u8fdb\\u5165\\u5fae\\u4fe1\\u5931\\u7269\\u62db\\u9886\\u6a21\\u5757"}}', '', 'gh_27fae299605f', 0, '0', 'wxbdf4d0bd4502e57c', 'ea7f97ae34bad091f98732e08412f94d', 0);
...
--
-- 表的结构 `wp_member_public_link`
--

CREATE TABLE IF NOT EXISTS `wp_member_public_link` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
--
-- 转存表中的数据 `wp_member_public_link`
--

INSERT INTO `wp_member_public_link` (`id`, `uid`, `mp_id`, `is_creator`, `addon_status`, `is_use`) VALUES
(114, 1, 106, 1, '', 0),
(115, 1, 107, 1, '', 1),
(116, 1, 108, 1, '', 0),
(117, 367, 109, 1, '', 1);
...
CREATE TABLE IF NOT EXISTS `wp_model` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='文档模型表' AUTO_INCREMENT=179 ;
...
(85, 'custom_menu', '自定义菜单', 0, '', 1, '{"1":["sort","pid","title","keyword","url"]}', '1:基础', '', '', '', '', 'title:10%菜单名\r\nkeyword:10%关联关键词\r\nurl:50%关联URL\r\nsort:5%排序号\r\nid:10%操作:[EDIT]|编辑,[DELETE]|删除', 10, 'title', '', 1394518309, 1407571484, 1, 'MyISAM'),
...
(365, 'http://schoolvip-public.stor.sinaapp.com/Picture/2015-09-24/560396e70392d5.71774773.jpg', 'http://schoolvip-public.stor.sinaapp.com/Picture/2015-09-24/560396e70392d5.71774773.jpg', 'e93a82a5689e2035461b12f6a8adc349', 'a1b5a39225b9fcc6a1e14d01e20d32085aa16e31', 1, 1443075814),
(366, 'http://schoolvip-public.stor.sinaapp.com/Picture/2015-09-24/5603a298265c90.33351270.jpg', 'http://schoolvip-public.stor.sinaapp.com/Picture/2015-09-24/5603a298265c90.33351270.jpg', '5e68ab017981cd6ecbbbdf131943078b', 'bbc839ca5930dbcee547dc2708f9bee3bc1f0724', 1, 1443078808),
(367, 'http://schoolvip-public.stor.sinaapp.com/Picture/2015-09-24/560402edc31558.54337862.JPG', 'http://schoolvip-public.stor.sinaapp.com/Picture/2015-09-24/560402edc31558.54337862.JPG', 'b4fd50f95c8fa6a59a189e030bbcdecd', '70fb67db7d57770a5c8b56ef1d59c71d6f488a26', 1, 1443103469),
(368, 'http://schoolvip-public.stor.sinaapp.com/Picture/2015-09-24/560402ef6a4098.08677615.jpg', 'http://schoolvip-public.stor.sinaapp.com/Picture/2015-09-24/560402ef6a4098.08677615.jpg', 'b7fb052cd4ff1987aa1d9aef359037dd', 'f1d29f0a87d9399ffe4fffa9028cc41d538c420f', 1, 1443103471),
(369, 'http://schoolvip-public.stor.sinaapp.com/Picture/2015-09-24/560406c7756ea1.32132124.jpg', 'http://schoolvip-public.stor.sinaapp.com/Picture/2015-09-24/560406c7756ea1.32132124.jpg', '91de04759452108b85034183fc6ddd0e', '6b6354b4a1ea5fd73d890f69e921d3469751e049', 1, 1443104455);
...
INSERT INTO `wp_prize` (`id`, `addon`, `target_id`, `title`, `name`, `num`, `sort`, `img`, `token`) VALUES
(35, 'Scratch', 22, '一等奖', '鼠标垫', 10, 0, 0, 'gh_27fae299605f');
...
INSERT INTO `wp_scratch` (`id`, `keyword`, `use_tips`, `title`, `intro`, `end_time`, `cover`, `cTime`, `token`, `start_time`, `end_tips`, `predict_num`, `max_num`, `follower_condtion`, `credit_conditon`, `credit_bug`, `addon_condition`, `collect_count`, `view_count`, `update_time`, `end_img`) VALUES
(22, '刮刮卡', '赶紧刮一刮呀', '刮刮卡', '<p> 第一步：关注微信公众账号 校园VIP  <img src="http://schoolvip-public.stor.sinaapp.com/Picture%2F2015-09-24%2F5603a298265c90.33351270.jpg" /></p>\r\n                            <p> 第二步：回复<strong> 刮刮卡 </strong>三个汉字</p>\r\n                            <p> 第三步：点击图文消息进入刮奖页面</p>\r\n                            <p> 第四步：刮掉涂层查看中奖结果</p>', 1443628800, 0, 1443074725, 'gh_27fae299605f', 1443074400, '活动已结束', 2000, 3, '1', 0, 0, '', 0, 0, 1443088662, 0);
...
INSERT INTO `wp_sn_code` (`id`, `sn`, `uid`, `cTime`, `is_use`, `use_time`, `addon`, `target_id`, `prize_id`, `status`, `prize_title`, `token`) VALUES
(174, '5603932b67df7', -3358, 1443074859, 0, 0, 'Scratch', 22, 35, 1, '一等奖', ''),
(175, '5603936e1c525', -3359, 1443074926, 0, 0, 'Scratch', 22, 35, 1, '一等奖', ''),
(176, '5603b2edb1d8f', 1, 1443082989, 0, 0, 'Scratch', 22, 35, 1, '一等奖', ''),
(177, '5603b35814fec', 365, 1443083096, 0, 0, 'Scratch', 22, 0, 1, '', ''),
(178, '5603c3fb4a0c6', 365, 1443087355, 0, 0, 'Scratch', 22, 0, 1, '', ''),
(179, '5603c405845f1', 365, 1443087365, 0, 0, 'Scratch', 22, 0, 1, '', '');
...
INSERT INTO `wp_tongji` (`id`, `token`, `month`, `day`, `content`) VALUES
(1, 'gh_5f4db4683ba9', 201509, 20150924, 'a:10:{s:4:"Chat";i:10;s:11:"CustomReply";i:8;s:6:"Wecome";i:1;s:4:"Card";i:1;s:4:"Exam";i:1;s:10:"UserCenter";i:1;s:8:"Leaflets";i:1;s:6:"Survey";i:1;s:6:"Coupon";i:1;s:4:"Vote";i:2;}'),
(2, 'gh_27fae299605f', 201509, 20150924, 'a:32:{s:4:"Chat";i:27;s:11:"CustomReply";i:12;s:7:"Scratch";i:100;s:4:"Test";i:4;s:5:"Robot";i:6;s:10:"Extensions";i:11;s:7:"WeiSite";i:7;s:5:"Forms";i:3;s:5:"Xydzp";i:130;s:4:"Exam";i:5;s:13:"YouaskService";i:3;s:10:"UserCenter";i:26;s:10:"MoonEating";i:5;s:7:"Jianzhi";i:27;s:4:"Love";i:7;s:8:"Leaflets";i:8;s:6:"Wecome";i:4;s:2:"Dg";i:1;s:4:"Juhe";i:1;s:3:"Diy";i:10;s:6:"Survey";i:5;s:10:"CustomMenu";i:2;s:4:"Game";i:2;s:10:"HelloWorld";i:1;s:4:"Card";i:5;s:6:"Coupon";i:6;s:4:"Vote";i:4;s:11:"Suggestions";i:2;s:6:"Wemall";i:13;s:12:"LostAndFound";i:10;s:5:"Hotel";i:22;s:6:"Nearby";i:1;}'),
(3, '-1', 201509, 20150924, 'a:1:{s:7:"Scratch";i:13;}'),
(4, 'gh_0edc27007a5f', 201509, 20150924, 'a:2:{s:4:"Chat";i:1;s:4:"Card";i:6;}');
...
CREATE TABLE IF NOT EXISTS `wp_ucenter_member` (
  ...
  KEY `status` (`status`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='用户表' AUTO_INCREMENT=368 ;

--
-- 转存表中的数据 `wp_ucenter_member`
--

INSERT INTO `wp_ucenter_member` (`id`, `username`, `password`, `email`, `mobile`, `reg_time`, `reg_ip`, `last_login_time`, `last_login_ip`, `update_time`, `status`, `openid`, `token`) VALUES
(1, 'admin', '1db01407236da1c1344433533350fefc', '291070726@qq.com', '', 1443103321, 1017458442, 1443103345, 1017458442, 1443103321, 1, NULL, NULL),
(363, 'lq767925949', 'e66176a1862f342eb598628ac643be15', '767925949@qq.com', '', 1443023769, 1971854151, 1443023816, 1971854151, 1443023769, 1, NULL, NULL),
(364, '头上长草', '2d4a50dd24c1aa3076710dd2a45df5f2', '1342814449@qq.com', '', 1443023810, 2090394631, 1443023873, 2090394631, 1443023810, 1, NULL, NULL),
(365, 'rayu', '9aab57dbc603138a4104a6f692209ac1', '144307863339@weiphp.cn', '123456', 1443078633, 2362390089, 0, 0, 1443078633, 1, 'oG1VFuC3h-uNaPoec8TSfKCQbnA0', 'gh_27fae299605f'),
(366, '5603fe6de008465', '9aab57dbc603138a4104a6f692209ac1', '144310231712@weiphp.cn', '', 1443102317, 1709325909, 0, 0, 1443102317, 1, 'oIOCHs500xC_ytopdq-45oGEg5c8', 'gh_0edc27007a5f'),
(367, '110', '9aab57dbc603138a4104a6f692209ac1', '111@qq.com', '', 1443103277, 1017458442, 1443103364, 1939496078, 1443103277, 1, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `wp_weixin_log` (
  ...
  `data_post` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=7303 ;
...
(7213, 1443071363, '2015-09-24 13:09:23', 'a:6:{s:10:"ToUserName";s:15:"gh_5f4db4683ba9";s:12:"FromUserName";s:28:"oD9LBuNv5nKwF2tg2n50dhmy9mB0";s:10:"CreateTime";s:10:"1443071362";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"你好";s:5:"MsgId";s:19:"6197944305793421914";}', '<xml><ToUserName><![CDATA[gh_5f4db4683ba9]]></ToUserName>\n<FromUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></FromUserName>\n<CreateTime>1443071362</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[你好]]></Content>\n<MsgId>6197944305793421914</MsgId>\n</xml>'),
(7214, 1443071364, '2015-09-24 13:09:24', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></ToUserName><FromUserName><![CDATA[gh_5f4db4683ba9]]></FromUserName><CreateTime>1443071362</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7215, 1443071440, '2015-09-24 13:10:40', 'a:7:{s:10:"ToUserName";s:15:"gh_5f4db4683ba9";s:12:"FromUserName";s:28:"oD9LBuNv5nKwF2tg2n50dhmy9mB0";s:10:"CreateTime";s:10:"1443071439";s:7:"MsgType";s:5:"image";s:6:"PicUrl";s:122:"http://mmbiz.qpic.cn/mmbiz/1ibupSJicJl5ibAv34TJk9CJD6aDLFZ4DQjZeibpNAEMTrcDMTyXTnianZdib9oiclDvOM5umu6El8uXftB8BQbbpGLhQ/0";s:5:"MsgId";s:19:"6197944636505903737";s:7:"MediaId";s:64:"BXiJUe9lNt5rtl8Kp5XAeqGmyfORc9lN1zB2he1YFCle2PYhx5e6QvIDfUs3HPEm";}', '<xml><ToUserName><![CDATA[gh_5f4db4683ba9]]></ToUserName>\n<FromUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></FromUserName>\n<CreateTime>1443071439</CreateTime>\n<MsgType><![CDATA[image]]></MsgType>\n<PicUrl><![CDATA[http://mmbiz.qpic.cn/mmbiz/1ibupSJicJl5ibAv34TJk9CJD6aDLFZ4DQjZeibpNAEMTrcDMTyXTnianZdib9oiclDvOM5umu6El8uXftB8BQbbpGLhQ/0]]></PicUrl>\n<MsgId>6197944636505903737</MsgId>\n<MediaId><![CDATA[BXiJUe9lNt5rtl8Kp5XAeqGmyfORc9lN1zB2he1YFCle2PYhx5e6QvIDfUs3HPEm]]></MediaId>\n</xml>'),
(7216, 1443071440, '2015-09-24 13:10:40', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></ToUserName><FromUserName><![CDATA[gh_5f4db4683ba9]]></FromUserName><CreateTime>1443071440</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7217, 1443072215, '2015-09-24 13:23:35', 'a:6:{s:10:"ToUserName";s:15:"gh_5f4db4683ba9";s:12:"FromUserName";s:28:"oD9LBuNv5nKwF2tg2n50dhmy9mB0";s:10:"CreateTime";s:10:"1443072215";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"你好";s:5:"MsgId";s:19:"6197947969400525735";}', '<xml><ToUserName><![CDATA[gh_5f4db4683ba9]]></ToUserName>\n<FromUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></FromUserName>\n<CreateTime>1443072215</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[你好]]></Content>\n<MsgId>6197947969400525735</MsgId>\n</xml>'),
(7218, 1443072216, '2015-09-24 13:23:36', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></ToUserName><FromUserName><![CDATA[gh_5f4db4683ba9]]></FromUserName><CreateTime>1443072215</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7219, 1443074519, '2015-09-24 14:01:59', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443074519";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"你好";s:5:"MsgId";s:19:"6197957865005209335";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443074519</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[你好]]></Content>\n<MsgId>6197957865005209335</MsgId>\n</xml>'),
(7220, 1443074519, '2015-09-24 14:01:59', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443074519</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7221, 1443074590, '2015-09-24 14:03:10', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443074589";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"你好";s:5:"MsgId";s:19:"6197958165652920084";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443074589</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[你好]]></Content>\n<MsgId>6197958165652920084</MsgId>\n</xml>'),
(7222, 1443074590, '2015-09-24 14:03:10', '<?xml version="1.0"?>\n<xml><Content><![CDATA[你好啊]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443074589</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7223, 1443074735, '2015-09-24 14:05:35', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443074734";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"刮刮卡";s:5:"MsgId";s:19:"6197958788423178046";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443074734</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[刮刮卡]]></Content>\n<MsgId>6197958788423178046</MsgId>\n</xml>'),
(7224, 1443074735, '2015-09-24 14:05:35', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[刮刮卡]]></Title><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/Scratch/Scratch/show/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0/id/22.html]]></Url><Description><![CDATA[]]></Description><PicUrl><![CDATA[http://schoolvip.sinaapp.com/Addons/Scratch/View/default/Public/cover_pic.jpg]]></PicUrl></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443074735</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7225, 1443074828, '2015-09-24 14:07:08', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443074828";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"刮刮卡";s:5:"MsgId";s:19:"6197959192150103894";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443074828</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[刮刮卡]]></Content>\n<MsgId>6197959192150103894</MsgId>\n</xml>'),
(7226, 1443074829, '2015-09-24 14:07:09', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[刮刮卡]]></Title><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/Scratch/Scratch/show/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0/id/22.html]]></Url><Description><![CDATA[]]></Description><PicUrl><![CDATA[http://schoolvip.sinaapp.com/Addons/Scratch/View/default/Public/cover_pic.jpg]]></PicUrl></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443074828</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7227, 1443075991, '2015-09-24 14:26:31', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443075990";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"成绩";s:5:"MsgId";s:19:"6197964182902102193";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443075990</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[成绩]]></Content>\n<MsgId>6197964182902102193</MsgId>\n</xml>'),
(7228, 1443076013, '2015-09-24 14:26:53', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443076012";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"校车";s:5:"MsgId";s:19:"6197964277391382711";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443076012</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[校车]]></Content>\n<MsgId>6197964277391382711</MsgId>\n</xml>'),
(7229, 1443076244, '2015-09-24 14:30:44', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443076244";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"成绩";s:5:"MsgId";s:19:"6197965273823795438";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443076244</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[成绩]]></Content>\n<MsgId>6197965273823795438</MsgId>\n</xml>'),
(7230, 1443076252, '2015-09-24 14:30:52', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443076252";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"课表";s:5:"MsgId";s:19:"6197965308183533808";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443076252</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[课表]]></Content>\n<MsgId>6197965308183533808</MsgId>\n</xml>'),
(7231, 1443078075, '2015-09-24 15:01:15', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443078075";s:7:"MsgType";s:4:"text";s:7:"Content";s:12:"进击玉兔";s:5:"MsgId";s:19:"6197973137908914858";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443078075</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[进击玉兔]]></Content>\n<MsgId>6197973137908914858</MsgId>\n</xml>'),
(7232, 1443078075, '2015-09-24 15:01:15', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[进击玉兔]]></Title><Description><![CDATA[进入游戏]]></Description><PicUrl><![CDATA[]]></PicUrl><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/MoonEating/MoonEating/index/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0.html]]></Url></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443078075</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7233, 1443078483, '2015-09-24 15:08:03', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443078483";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"兼职";s:5:"MsgId";s:19:"6197974890255571748";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443078483</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[兼职]]></Content>\n<MsgId>6197974890255571748</MsgId>\n</xml>'),
(7234, 1443078483, '2015-09-24 15:08:03', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[微信兼职信息平台]]></Title><Description><![CDATA[最全的兼职信息平台，让你轻轻松松找到兼职]]></Description><PicUrl><![CDATA[http://img.wdjimg.com/mms/icon/v1/e/08/0f7cb18996b23754fed4b5fed2ff808e_256_256.png]]></PicUrl><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/Jianzhi/Jianzhi/index/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0.html]]></Url></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443078483</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7235, 1443078584, '2015-09-24 15:09:44', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443078584";s:7:"MsgType";s:5:"event";s:5:"Event";s:11:"unsubscribe";s:8:"EventKey";s:0:"";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443078584</CreateTime>\n<MsgType><![CDATA[event]]></MsgType>\n<Event><![CDATA[unsubscribe]]></Event>\n<EventKey><![CDATA[]]></EventKey>\n</xml>'),
(7236, 1443078633, '2015-09-24 15:10:33', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443078632";s:7:"MsgType";s:5:"event";s:5:"Event";s:9:"subscribe";s:8:"EventKey";s:0:"";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443078632</CreateTime>\n<MsgType><![CDATA[event]]></MsgType>\n<Event><![CDATA[subscribe]]></Event>\n<EventKey><![CDATA[]]></EventKey>\n</xml>'),
(7237, 1443078633, '2015-09-24 15:10:33', '<?xml version="1.0"?>\n<xml><Content><![CDATA[]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443078633</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7238, 1443078698, '2015-09-24 15:11:38', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443078698";s:7:"MsgType";s:5:"event";s:5:"Event";s:11:"unsubscribe";s:8:"EventKey";s:0:"";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443078698</CreateTime>\n<MsgType><![CDATA[event]]></MsgType>\n<Event><![CDATA[unsubscribe]]></Event>\n<EventKey><![CDATA[]]></EventKey>\n</xml>'),
(7239, 1443079461, '2015-09-24 15:24:21', '<?xml version="1.0"?>\n<xml><Content><![CDATA[请先<a href="http://schoolvip.sinaapp.com/index.php?s=/addon/UserCenter/UserCenter/edit/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0.html">绑定帐号</a>再使用]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443079461</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7240, 1443079614, '2015-09-24 15:26:54', '<?xml version="1.0"?>\n<xml><Content><![CDATA[请先<a href="http://schoolvip.sinaapp.com/index.php?s=/addon/UserCenter/UserCenter/edit/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0.html">绑定帐号</a>再使用]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443079614</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7241, 1443079630, '2015-09-24 15:27:10', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443079629";s:7:"MsgType";s:4:"text";s:7:"Content";s:18:"微信用户中心";s:5:"MsgId";s:19:"6197979812288093235";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443079629</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[微信用户中心]]></Content>\n<MsgId>6197979812288093235</MsgId>\n</xml>'),
(7242, 1443079630, '2015-09-24 15:27:10', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[个人中心]]></Title><Description><![CDATA[点此进入]]></Description><PicUrl><![CDATA[http://ipic-ipic.stor.sinaapp.com/original/2ddfdc417b03d7f43bbcb32eba079db0.jpg]]></PicUrl><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/UserCenter/UserCenter/my/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0/token/gh_27fae299605f.html]]></Url></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443079629</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7243, 1443079673, '2015-09-24 15:27:53', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443079673";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"你好";s:5:"MsgId";s:19:"6197980001266654278";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443079673</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[你好]]></Content>\n<MsgId>6197980001266654278</MsgId>\n</xml>'),
(7244, 1443079674, '2015-09-24 15:27:54', '<?xml version="1.0"?>\n<xml><Content><![CDATA[你好啊]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443079673</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7245, 1443079724, '2015-09-24 15:28:44', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443079723";s:7:"MsgType";s:4:"text";s:7:"Content";s:12:"进击玉兔";s:5:"MsgId";s:19:"6197980216015019090";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443079723</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[进击玉兔]]></Content>\n<MsgId>6197980216015019090</MsgId>\n</xml>'),
(7246, 1443079724, '2015-09-24 15:28:44', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[进击玉兔]]></Title><Description><![CDATA[进入游戏]]></Description><PicUrl><![CDATA[]]></PicUrl><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/MoonEating/MoonEating/index/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0.html]]></Url></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443079723</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7247, 1443079817, '2015-09-24 15:30:17', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443079817";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"表白墙";s:5:"MsgId";s:19:"6197980619741944929";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443079817</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[表白墙]]></Content>\n<MsgId>6197980619741944929</MsgId>\n</xml>'),
(7248, 1443079817, '2015-09-24 15:30:17', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[微信表白墙]]></Title><Description><![CDATA[请勇敢说出你的爱]]></Description><PicUrl><![CDATA[http://pic21.nipic.com/20120519/6589089_105229006397_2.jpg]]></PicUrl><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/Love/Love/show/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0.html]]></Url></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443079817</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7249, 1443079877, '2015-09-24 15:31:17', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443079877";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"游戏";s:5:"MsgId";s:19:"6197980877439982704";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443079877</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[游戏]]></Content>\n<MsgId>6197980877439982704</MsgId>\n</xml>'),
(7250, 1443079877, '2015-09-24 15:31:17', '<?xml version="1.0"?>\n<xml><ArticleCount>7</ArticleCount><Articles><item><Title><![CDATA[八戒吃月饼]]></Title><Description><![CDATA[]]></Description><PicUrl><![CDATA[]]></PicUrl><Url><![CDATA[http://www.hlo.cc/weixin/bajieyb/]]></Url></item><item><Title>2048</Title><Description><![CDATA[]]></Description><PicUrl><![CDATA[]]></PicUrl><Url><![CDATA[http://gabrielecirulli.github.io/2048/]]></Url></item><item><Title><![CDATA[围住神经猫]]></Title><Description><![CDATA[]]></Description><PicUrl><![CDATA[]]></PicUrl><Url><![CDATA[http://u.ali213.net/games/shenjingcat/index.html?game_code=196&bs=wx]]></Url></item><item><Title><![CDATA[一个都不能死]]></Title><Description><![CDATA[]]></Description><PicUrl><![CDATA[]]></PicUrl><Url><![CDATA[http://run.app100725914.twsapp.com/index.php?openid=1A5127D7691F6098331D7D0D8F9BBE2E&openkey=5B50BCB]]></Url></item><item><Title><![CDATA[危险游戏]]></Title><Description><![CDATA[]]></Description><PicUrl><![CDATA[]]></PicUrl><Url><![CDATA[http://m.edianyou.com/h5game/Danger%20Ranger.html#rd]]></Url></item><item><Title><![CDATA[最强眼力]]></Title><Description><![CDATA[试试看你的眼力有多强]]></Description><PicUrl><![CDATA[]]></PicUrl><Url><![CDATA[http://1.chinspro.sinaapp.com/%E6%9C%80%E5%BC%BA%E7%9C%BC%E5%8A%9B/index.html]]></Url></item><item><Title><![CDATA[点此试玩更多微信小游戏]]></Title><Description><![CDATA[]]></Description><PicUrl><![CDATA[]]></PicUrl><Url><![CDATA[http://2014.demoidoubi.sinaapp.com/game/index.html]]></Url></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443079877</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7251, 1443081140, '2015-09-24 15:52:20', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443081140";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"大转盘";s:5:"MsgId";s:19:"6197986301983677950";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443081140</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[大转盘]]></Content>\n<MsgId>6197986301983677950</MsgId>\n</xml>'),
(7252, 1443081141, '2015-09-24 15:52:21', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443081140</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7253, 1443081141, '2015-09-24 15:52:21', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443081141";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"哈哈哈";s:5:"MsgId";s:19:"6197986306278645247";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443081141</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[哈哈哈]]></Content>\n<MsgId>6197986306278645247</MsgId>\n</xml>'),
(7254, 1443081141, '2015-09-24 15:52:21', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443081141</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7255, 1443081154, '2015-09-24 15:52:34', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443081153";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"哈哈";s:5:"MsgId";s:19:"6197986357818252812";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443081153</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[哈哈]]></Content>\n<MsgId>6197986357818252812</MsgId>\n</xml>'),
(7256, 1443081154, '2015-09-24 15:52:34', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443081153</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7257, 1443081606, '2015-09-24 16:00:06', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443081606";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"兼职";s:5:"MsgId";s:19:"6197988303438438004";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443081606</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[兼职]]></Content>\n<MsgId>6197988303438438004</MsgId>\n</xml>'),
(7258, 1443081606, '2015-09-24 16:00:06', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[微信兼职信息平台]]></Title><Description><![CDATA[最全的兼职信息平台，让你轻轻松松找到兼职]]></Description><PicUrl><![CDATA[http://img.wdjimg.com/mms/icon/v1/e/08/0f7cb18996b23754fed4b5fed2ff808e_256_256.png]]></PicUrl><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/Jianzhi/Jianzhi/index/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0.html]]></Url></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443081606</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7259, 1443081698, '2015-09-24 16:01:38', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443081698";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"哈哈哈";s:5:"MsgId";s:19:"6197988698575429256";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443081698</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[哈哈哈]]></Content>\n<MsgId>6197988698575429256</MsgId>\n</xml>'),
(7260, 1443081699, '2015-09-24 16:01:39', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443081698</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7261, 1443081706, '2015-09-24 16:01:46', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443081706";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"机器人";s:5:"MsgId";s:19:"6197988732935167627";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443081706</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[机器人]]></Content>\n<MsgId>6197988732935167627</MsgId>\n</xml>'),
(7262, 1443081707, '2015-09-24 16:01:47', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443081706</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7263, 1443081971, '2015-09-24 16:06:11', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443081971";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"赵薇";s:5:"MsgId";s:19:"6197989871101501137";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443081971</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[赵薇]]></Content>\n<MsgId>6197989871101501137</MsgId>\n</xml>'),
(7264, 1443081974, '2015-09-24 16:06:14', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443081971</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7265, 1443083079, '2015-09-24 16:24:39', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443083078";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"刮刮卡";s:5:"MsgId";s:19:"6197994625630298034";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443083078</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[刮刮卡]]></Content>\n<MsgId>6197994625630298034</MsgId>\n</xml>'),
(7266, 1443083079, '2015-09-24 16:24:39', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[刮刮卡]]></Title><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/Scratch/Scratch/show/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0/id/22.html]]></Url><Description><![CDATA[]]></Description><PicUrl><![CDATA[http://schoolvip.sinaapp.com/Addons/Scratch/View/default/Public/cover_pic.jpg]]></PicUrl></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443083079</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7267, 1443083266, '2015-09-24 16:27:46', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443083266";s:7:"MsgType";s:4:"text";s:7:"Content";s:21:"机器人学习时间";s:5:"MsgId";s:19:"6197995433084149709";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443083266</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[机器人学习时间]]></Content>\n<MsgId>6197995433084149709</MsgId>\n</xml>'),
(7268, 1443083268, '2015-09-24 16:27:48', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443083266</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7269, 1443084723, '2015-09-24 16:52:03', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443084723";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"大转盘";s:5:"MsgId";s:19:"6198001690851500462";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443084723</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[大转盘]]></Content>\n<MsgId>6198001690851500462</MsgId>\n</xml>'),
(7270, 1443084723, '2015-09-24 16:52:03', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[大转盘]]></Title><Description><![CDATA[]]></Description><PicUrl><![CDATA[]]></PicUrl><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/Xydzp/Xydzp/show/id/1/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0.html]]></Url></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443084723</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7271, 1443087322, '2015-09-24 17:35:22', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443087322";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"刮刮卡";s:5:"MsgId";s:19:"6198012853471503653";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443087322</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[刮刮卡]]></Content>\n<MsgId>6198012853471503653</MsgId>\n</xml>'),
(7272, 1443087322, '2015-09-24 17:35:22', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[刮刮卡]]></Title><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/Scratch/Scratch/show/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0/id/22.html]]></Url><Description><![CDATA[]]></Description><PicUrl><![CDATA[http://schoolvip.sinaapp.com/Addons/Scratch/View/default/Public/cover_pic.jpg]]></PicUrl></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443087322</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7273, 1443087613, '2015-09-24 17:40:13', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443087613";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"刮刮卡";s:5:"MsgId";s:19:"6198014103306986885";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443087613</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[刮刮卡]]></Content>\n<MsgId>6198014103306986885</MsgId>\n</xml>'),
(7274, 1443087613, '2015-09-24 17:40:13', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[刮刮卡]]></Title><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/Scratch/Scratch/show/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0/id/22.html]]></Url><Description><![CDATA[]]></Description><PicUrl><![CDATA[http://schoolvip.sinaapp.com/Addons/Scratch/View/default/Public/cover_pic.jpg]]></PicUrl></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443087613</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7275, 1443102302, '2015-09-24 21:45:02', 'a:6:{s:10:"ToUserName";s:15:"gh_0edc27007a5f";s:12:"FromUserName";s:28:"oIOCHs500xC_ytopdq-45oGEg5c8";s:10:"CreateTime";s:10:"1443102302";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"你好";s:5:"MsgId";s:19:"6198077192085427512";}', '<xml><ToUserName><![CDATA[gh_0edc27007a5f]]></ToUserName>\n<FromUserName><![CDATA[oIOCHs500xC_ytopdq-45oGEg5c8]]></FromUserName>\n<CreateTime>1443102302</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[你好]]></Content>\n<MsgId>6198077192085427512</MsgId>\n</xml>'),
(7276, 1443102303, '2015-09-24 21:45:03', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oIOCHs500xC_ytopdq-45oGEg5c8]]></ToUserName><FromUserName><![CDATA[gh_0edc27007a5f]]></FromUserName><CreateTime>1443102302</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7277, 1443102317, '2015-09-24 21:45:17', 'a:6:{s:10:"ToUserName";s:15:"gh_0edc27007a5f";s:12:"FromUserName";s:28:"oIOCHs500xC_ytopdq-45oGEg5c8";s:10:"CreateTime";s:10:"1443102317";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"会员卡";s:5:"MsgId";s:19:"6198077256509936956";}', '<xml><ToUserName><![CDATA[gh_0edc27007a5f]]></ToUserName>\n<FromUserName><![CDATA[oIOCHs500xC_ytopdq-45oGEg5c8]]></FromUserName>\n<CreateTime>1443102317</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[会员卡]]></Content>\n<MsgId>6198077256509936956</MsgId>\n</xml>'),
(7278, 1443102317, '2015-09-24 21:45:17', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[时尚美容美发店VIP会员卡]]></Title><Description><![CDATA[]]></Description><PicUrl><![CDATA[http://schoolvip.sinaapp.com/Addons/Card/View/default/Public/cover.png]]></PicUrl><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/Card/Card/show/token/gh_0edc27007a5f/openid/oIOCHs500xC_ytopdq-45oGEg5c8.html]]></Url></item></Articles><ToUserName><![CDATA[oIOCHs500xC_ytopdq-45oGEg5c8]]></ToUserName><FromUserName><![CDATA[gh_0edc27007a5f]]></FromUserName><CreateTime>1443102317</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7279, 1443103076, '2015-09-24 21:57:56', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443103076";s:7:"MsgType";s:4:"text";s:7:"Content";s:12:"失物招领";s:5:"MsgId";s:19:"6198080516386288635";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443103076</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[失物招领]]></Content>\n<MsgId>6198080516386288635</MsgId>\n</xml>'),
(7280, 1443103077, '2015-09-24 21:57:57', '<?xml version="1.0"?>\n<xml><ArticleCount>1</ArticleCount><Articles><item><Title><![CDATA[失物招领]]></Title><Description><![CDATA[丢失物品，轻松找回，请点击此处进入微信失物招领模块]]></Description><PicUrl><![CDATA[]]></PicUrl><Url><![CDATA[http://schoolvip.sinaapp.com/index.php?s=/addon/LostAndFound/LostAndFound/index/token/gh_27fae299605f/openid/oG1VFuC3h-uNaPoec8TSfKCQbnA0.html]]></Url></item></Articles><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443103076</CreateTime><MsgType><![CDATA[news]]></MsgType></xml>\n', '_replyData'),
(7281, 1443103193, '2015-09-24 21:59:53', 'a:7:{s:10:"ToUserName";s:15:"gh_5f4db4683ba9";s:12:"FromUserName";s:28:"oD9LBuNv5nKwF2tg2n50dhmy9mB0";s:10:"CreateTime";s:10:"1443103192";s:7:"MsgType";s:5:"image";s:6:"PicUrl";s:121:"http://mmbiz.qpic.cn/mmbiz/1ibupSJicJl5ibAv34TJk9CJD6aDLFZ4DQj5AugjicsXkdQUS650Y4oia3zB3xTnC3qic7C4lQDjrrA52G7qVDmUak5Q/0";s:5:"MsgId";s:19:"6198081014602460099";s:7:"MediaId";s:64:"o0Xwl4tWt1vaBLoxmY3TipHrkMxAr_ciR7482rw1RuYY4W0Nh1bHrevhL4SIg6vR";}', '<xml><ToUserName><![CDATA[gh_5f4db4683ba9]]></ToUserName>\n<FromUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></FromUserName>\n<CreateTime>1443103192</CreateTime>\n<MsgType><![CDATA[image]]></MsgType>\n<PicUrl><![CDATA[http://mmbiz.qpic.cn/mmbiz/1ibupSJicJl5ibAv34TJk9CJD6aDLFZ4DQj5AugjicsXkdQUS650Y4oia3zB3xTnC3qic7C4lQDjrrA52G7qVDmUak5Q/0]]></PicUrl>\n<MsgId>6198081014602460099</MsgId>\n<MediaId><![CDATA[o0Xwl4tWt1vaBLoxmY3TipHrkMxAr_ciR7482rw1RuYY4W0Nh1bHrevhL4SIg6vR]]></MediaId>\n</xml>'),
(7282, 1443103193, '2015-09-24 21:59:53', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></ToUserName><FromUserName><![CDATA[gh_5f4db4683ba9]]></FromUserName><CreateTime>1443103193</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7283, 1443103796, '2015-09-24 22:09:56', 'a:6:{s:10:"ToUserName";s:15:"gh_5f4db4683ba9";s:12:"FromUserName";s:28:"oD9LBuNv5nKwF2tg2n50dhmy9mB0";s:10:"CreateTime";s:10:"1443103795";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"你好";s:5:"MsgId";s:19:"6198083604467739727";}', '<xml><ToUserName><![CDATA[gh_5f4db4683ba9]]></ToUserName>\n<FromUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></FromUserName>\n<CreateTime>1443103795</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[你好]]></Content>\n<MsgId>6198083604467739727</MsgId>\n</xml>'),
(7284, 1443103796, '2015-09-24 22:09:56', '<?xml version="1.0"?>\n<xml><Content><![CDATA[你好]]></Content><ToUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></ToUserName><FromUserName><![CDATA[gh_5f4db4683ba9]]></FromUserName><CreateTime>1443103795</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7285, 1443103802, '2015-09-24 22:10:02', 'a:6:{s:10:"ToUserName";s:15:"gh_5f4db4683ba9";s:12:"FromUserName";s:28:"oD9LBuNv5nKwF2tg2n50dhmy9mB0";s:10:"CreateTime";s:10:"1443103802";s:7:"MsgType";s:4:"text";s:7:"Content";s:9:"拉拉啦";s:5:"MsgId";s:19:"6198083634532510803";}', '<xml><ToUserName><![CDATA[gh_5f4db4683ba9]]></ToUserName>\n<FromUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></FromUserName>\n<CreateTime>1443103802</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[拉拉啦]]></Content>\n<MsgId>6198083634532510803</MsgId>\n</xml>'),
(7286, 1443103804, '2015-09-24 22:10:04', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></ToUserName><FromUserName><![CDATA[gh_5f4db4683ba9]]></FromUserName><CreateTime>1443103802</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7287, 1443103814, '2015-09-24 22:10:14', 'a:9:{s:10:"ToUserName";s:15:"gh_5f4db4683ba9";s:12:"FromUserName";s:28:"oD9LBuNv5nKwF2tg2n50dhmy9mB0";s:10:"CreateTime";s:10:"1443103814";s:7:"MsgType";s:8:"location";s:10:"Location_X";s:9:"34.243207";s:10:"Location_Y";s:10:"108.988490";s:5:"Scale";s:2:"15";s:5:"Label";s:63:"西安市碑林区学府首座(兴庆路/北沙坡街路口南)";s:5:"MsgId";s:19:"6198083686072118359";}', '<xml><ToUserName><![CDATA[gh_5f4db4683ba9]]></ToUserName>\n<FromUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></FromUserName>\n<CreateTime>1443103814</CreateTime>\n<MsgType><![CDATA[location]]></MsgType>\n<Location_X>34.243207</Location_X>\n<Location_Y>108.988490</Location_Y>\n<Scale>15</Scale>\n<Label><![CDATA[西安市碑林区学府首座(兴庆路/北沙坡街路口南)]]></Label>\n<MsgId>6198083686072118359</MsgId>\n</xml>'),
(7288, 1443103815, '2015-09-24 22:10:15', '<?xml version="1.0"?>\n<xml><Content><![CDATA[]]></Content><ToUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></ToUserName><FromUserName><![CDATA[gh_5f4db4683ba9]]></FromUserName><CreateTime>1443103814</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7289, 1443103844, '2015-09-24 22:10:44', 'a:7:{s:10:"ToUserName";s:15:"gh_5f4db4683ba9";s:12:"FromUserName";s:28:"oD9LBuNv5nKwF2tg2n50dhmy9mB0";s:10:"CreateTime";s:10:"1443103843";s:7:"MsgType";s:5:"image";s:6:"PicUrl";s:121:"http://mmbiz.qpic.cn/mmbiz/1ibupSJicJl5ibAv34TJk9CJD6aDLFZ4DQj3REiaicmfma7upjHia4dczdK1qsVsPL0I8tJnR4dQDJo5zvYcGIdD6TBg/0";s:5:"MsgId";s:19:"6198083810626169949";s:7:"MediaId";s:43:"MIqXxoVi9uNkKl_b2IkmcZ7ny-H3T_elYyFyaII05OU";}', '<xml><ToUserName><![CDATA[gh_5f4db4683ba9]]></ToUserName>\n<FromUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></FromUserName>\n<CreateTime>1443103843</CreateTime>\n<MsgType><![CDATA[image]]></MsgType>\n<PicUrl><![CDATA[http://mmbiz.qpic.cn/mmbiz/1ibupSJicJl5ibAv34TJk9CJD6aDLFZ4DQj3REiaicmfma7upjHia4dczdK1qsVsPL0I8tJnR4dQDJo5zvYcGIdD6TBg/0]]></PicUrl>\n<MsgId>6198083810626169949</MsgId>\n<MediaId><![CDATA[MIqXxoVi9uNkKl_b2IkmcZ7ny-H3T_elYyFyaII05OU]]></MediaId>\n</xml>'),
(7290, 1443103844, '2015-09-24 22:10:44', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oD9LBuNv5nKwF2tg2n50dhmy9mB0]]></ToUserName><FromUserName><![CDATA[gh_5f4db4683ba9]]></FromUserName><CreateTime>1443103844</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7291, 1443104507, '2015-09-24 22:21:47', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443104507";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"酒店";s:5:"MsgId";s:19:"6198086662484489626";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443104507</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[酒店]]></Content>\n<MsgId>6198086662484489626</MsgId>\n</xml>'),
(7292, 1443104508, '2015-09-24 22:21:48', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443104507</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7293, 1443104979, '2015-09-24 22:29:39', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443104979";s:7:"MsgType";s:4:"text";s:7:"Content";s:12:"民大之星";s:5:"MsgId";s:19:"6198088689709053587";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443104979</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[民大之星]]></Content>\n<MsgId>6198088689709053587</MsgId>\n</xml>'),
(7294, 1443104980, '2015-09-24 22:29:40', '<?xml version="1.0"?>\n<xml><Content><![CDATA[<html>\r\n<head><title>404 Not Found</title></head>\r\n<body bgcolor="white">\r\n<center><h1>404 Not Found</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443104979</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7295, 1443105265, '2015-09-24 22:34:25', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443105264";s:7:"MsgType";s:4:"text";s:7:"Content";s:6:"哈哈";s:5:"MsgId";s:19:"6198089913774733022";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443105264</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[哈哈]]></Content>\n<MsgId>6198089913774733022</MsgId>\n</xml>'),
(7296, 1443105265, '2015-09-24 22:34:25', '<?xml version="1.0"?>\n<xml><Content><![CDATA[嘿嘿]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443105265</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7297, 1443105279, '2015-09-24 22:34:39', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443105279";s:7:"MsgType";s:4:"text";s:7:"Content";s:18:"你叫什么名字";s:5:"MsgId";s:19:"6198089978199242480";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443105279</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[你叫什么名字]]></Content>\n<MsgId>6198089978199242480</MsgId>\n</xml>');
INSERT INTO `wp_weixin_log` (`id`, `cTime`, `cTime_format`, `data`, `data_post`) VALUES
(7298, 1443105280, '2015-09-24 22:34:40', '<?xml version="1.0"?>\n<xml><Content><![CDATA[我叫小薇，聪明又可爱的小薇]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443105279</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7299, 1443105308, '2015-09-24 22:35:08', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443105308";s:7:"MsgType";s:4:"text";s:7:"Content";s:15:"你吃饭了呀";s:5:"MsgId";s:19:"6198090102753294072";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443105308</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[你吃饭了呀]]></Content>\n<MsgId>6198090102753294072</MsgId>\n</xml>'),
(7300, 1443105308, '2015-09-24 22:35:08', '<?xml version="1.0"?>\n<xml><Content><![CDATA[我吃饭]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443105308</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData'),
(7301, 1443105314, '2015-09-24 22:35:14', 'a:6:{s:10:"ToUserName";s:15:"gh_27fae299605f";s:12:"FromUserName";s:28:"oG1VFuC3h-uNaPoec8TSfKCQbnA0";s:10:"CreateTime";s:10:"1443105314";s:7:"MsgType";s:4:"text";s:7:"Content";s:15:"讲个笑话呀";s:5:"MsgId";s:19:"6198090128523097870";}', '<xml><ToUserName><![CDATA[gh_27fae299605f]]></ToUserName>\n<FromUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></FromUserName>\n<CreateTime>1443105314</CreateTime>\n<MsgType><![CDATA[text]]></MsgType>\n<Content><![CDATA[讲个笑话呀]]></Content>\n<MsgId>6198090128523097870</MsgId>\n</xml>'),
(7302, 1443105315, '2015-09-24 22:35:15', '<?xml version="1.0"?>\n<xml><Content><![CDATA[小鱼:爸,这次段考我有一半科目不及格...父:没关系,继续努力就行了!!※※※※※※※一个月后※※※※※※※小鱼:爸,这次我有一半的科目及格耶..父:不错,有进步,继续努力...<br>]]></Content><ToUserName><![CDATA[oG1VFuC3h-uNaPoec8TSfKCQbnA0]]></ToUserName><FromUserName><![CDATA[gh_27fae299605f]]></FromUserName><CreateTime>1443105314</CreateTime><MsgType><![CDATA[text]]></MsgType></xml>\n', '_replyData');

-- --------------------------------------------------------

--
-- 表的结构 `wp_youaskservice_behavior`
--
...
--
-- 转存表中的数据 `wp_youaskservice_behavior`
--
...
--
-- 转存表中的数据 `wp_youaskservice_group`
--
...
--
-- 转存表中的数据 `wp_youaskservice_keyword`
--
...
--
-- 表的结构 `wp_youaskservice_wechat_enddate`
--
...
--
-- 转存表中的数据 `wp_youaskservice_wechat_enddate`
--
...
--
-- 表的结构 `wp_youaskservice_wechat_grouplist`
--
...
--
-- 转存表中的数据 `wp_youaskservice_wechat_grouplist`
--
...
--
-- 转存表中的数据 `wp_youaskservice_wxlogs`
--
