function Ship(ctx){
	gameMonitor.im.loadImage(['./Addons/MoonEating/View/default/Public/img/player.png']);
	this.width = 80;
	this.height = 80;
	this.left = gameMonitor.w/2 - this.width/2;
	this.top = gameMonitor.h - 2*this.height;
	this.player = gameMonitor.im.createImage('./Addons/MoonEating/View/default/Public/img/player.png');
...
function Food(type, left, id){
	...
	var p = this.type == 0 ? './Addons/MoonEating/View/default/Public/img/food1.png' : './Addons/MoonEating/View/default/Public/img/food2.png';
...
var gameMonitor = {
	...
	init : function(){
		...
		bg.src = './Addons/MoonEating/View/default/Public/img/bg.jpg';
	...
	initListener : function(ctx){
		...
		WeixinApi.ready(function(Api) {   
            ...
            var wxData = {
                "appId": "", 
                "imgUrl" : "./Addons/MoonEating/View/default/Public/img/icon.png",
