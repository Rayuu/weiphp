function Ship(ctx){
	gameMonitor.im.loadImage(['{:ADDON_PUBLIC_PATH}/static/img/player.png']);
	this.width = 80;
	this.height = 80;
	this.left = gameMonitor.w/2 - this.width/2;
	this.top = gameMonitor.h - 2*this.height;
	this.player = gameMonitor.im.createImage('{:ADDON_PUBLIC_PATH}/static/img/player.png');
...
function Food(type, left, id){
	...
	var p = this.type == 0 ? '{:ADDON_PUBLIC_PATH}/static/img/food1.png' : '{:ADDON_PUBLIC_PATH}/static/img/food2.png';
...
var gameMonitor = {
	...
	init : function(){
		...
		bg.src = '{:ADDON_PUBLIC_PATH}/static/img/bg.jpg';
	...
	initListener : function(ctx){
		...
		WeixinApi.ready(function(Api) {   
            ...
            var wxData = {
                "appId": "", 
                "imgUrl" : "{:ADDON_PUBLIC_PATH}/static/img/icon.png",
